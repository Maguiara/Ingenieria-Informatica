...
intercambia:
	...
	lw $t0, nFil($a0) #Numero de filas
	lw $t1, nCol($a0) #Numero de columnas
	addi $t5, $a0, elementos #Dirrecion del primer elemento de la columna 
...
find_min:
	lw $t0, nFil($a0) #Numero de filas
	lw $t1, nCol($a0) #Numero de columnas
	addi $t5, $a0, elementos #Primera direccion de los elementos
	beqz $t0, error
	j cargar_parametros
