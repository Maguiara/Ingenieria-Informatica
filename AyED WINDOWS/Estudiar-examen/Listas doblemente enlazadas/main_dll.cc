...
int main(void) {
  ...
  lista.insert_node(lista.get_head(), new dll_node_t<char>('/'));
  cout << "Insertando el elemento '/' en la segunda posicion..." << endl;
  lista.write();
  cout << endl;
  lista.insert_node(lista.get_tail()->get_prev(), new dll_node_t<char>('?'));
  cout << "Insertando el elemento '?' en la penultima posicion..." << endl;
  lista.write();
  cout << endl; 
